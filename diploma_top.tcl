...
################################################################
# This is a generated script based on design: diploma_top
#
...
proc create_root_design { parentCell } {
  ...
  set btn [ create_bd_port -dir I -from 1 -to 0 -type data btn ]
  ...
  if { [catch {set uart_top_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property CONFIG.SYNTHESIS {true} $uart_top_0
  ...
  [get_bd_pins uart_top_0/sw]
  connect_bd_net -net uart_top_0_addr_ram_b  [get_bd_pins uart_top_0/addr_ram_b] \
  [get_bd_pins blk_mem_gen_0/addrb]
  connect_bd_net -net uart_top_0_ce_ram_b  [get_bd_pins uart_top_0/ce_ram_b] \
  [get_bd_pins blk_mem_gen_0/enb]
  connect_bd_net -net uart_top_0_ck_io0  [get_bd_pins uart_top_0/ck_io0] \
  [get_bd_ports ck_io0]
  connect_bd_net -net uart_top_0_data_in_ram_b  [get_bd_pins uart_top_0/data_in_ram_b] \
  [get_bd_pins blk_mem_gen_0/dinb]
  connect_bd_net -net uart_top_0_led  [get_bd_pins uart_top_0/led] \
  [get_bd_ports led]
  connect_bd_net -net uart_top_0_we_ram_b  [get_bd_pins uart_top_0/we_ram_b] \
