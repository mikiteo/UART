...
set_property MARK_DEBUG true [get_nets {addr_ram_a[0]}]
set_property MARK_DEBUG true [get_nets {addr_ram_a[1]}]
set_property MARK_DEBUG true [get_nets {addr_ram_a[2]}]
set_property MARK_DEBUG true [get_nets {addr_ram_a[3]}]
set_property MARK_DEBUG true [get_nets {addr_ram_a[4]}]
set_property MARK_DEBUG true [get_nets {addr_ram_a[5]}]
set_property MARK_DEBUG true [get_nets {addr_ram_a[6]}]
set_property MARK_DEBUG true [get_nets {addr_ram_a[7]}]
set_property MARK_DEBUG true [get_nets {data_in_ram_a[0]}]
set_property MARK_DEBUG true [get_nets {data_in_ram_a[1]}]
set_property MARK_DEBUG true [get_nets {data_in_ram_a[2]}]
set_property MARK_DEBUG true [get_nets {data_in_ram_a[3]}]
set_property MARK_DEBUG true [get_nets {data_in_ram_a[4]}]
set_property MARK_DEBUG true [get_nets {data_in_ram_a[5]}]
set_property MARK_DEBUG true [get_nets {data_in_ram_a[6]}]
set_property MARK_DEBUG true [get_nets {data_in_ram_a[7]}]
set_property MARK_DEBUG true [get_nets we_ram_a]
...
connect_debug_port u_ila_0/clk [get_nets [list clock_gen_block.clock_genegate/inst/clk_out1]]
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe0]
set_property port_width 8 [get_debug_ports u_ila_0/probe0]
connect_debug_port u_ila_0/probe0 [get_nets [list {addr_ram_a[0]} {addr_ram_a[1]} {addr_ram_a[2]} {addr_ram_a[3]} {addr_ram_a[4]} {addr_ram_a[5]} {addr_ram_a[6]} {addr_ram_a[7]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 8 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list {data_in_ram_a[0]} {data_in_ram_a[1]} {data_in_ram_a[2]} {data_in_ram_a[3]} {data_in_ram_a[4]} {data_in_ram_a[5]} {data_in_ram_a[6]} {data_in_ram_a[7]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe2]
set_property port_width 1 [get_debug_ports u_ila_0/probe2]
connect_debug_port u_ila_0/probe2 [get_nets [list we_ram_a]]
